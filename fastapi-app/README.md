...
Простое FastAPI приложение с базовыми endpoints для демонстрации работы API.
...
Пример endpoint с параметром пути.

**Пример запроса:**
```bash
curl http://localhost:8002/api/v1/items/123
```
